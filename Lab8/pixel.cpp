/**
* This program models the abstraction of a pixel with a C++ class. No problem 
* is solved, just a fun exercise.
* 
...
/**
 * @brief      gets red value
 *
 * @return     { returns red value }
 */
...
Pixel Pixel::operator+(const Pixel& rhs){
	Pixel temp;
	int g = green_ + rhs.green_;
	int b = blue_ + rhs.blue_;
	int r = red_ + rhs.red_;
	clip(g);
	clip(b);
	clip(r);
